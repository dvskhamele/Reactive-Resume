...
Finally, create a pull request to merge the changes on your forked repository to the original repository hosted on signimus-tech/Signimus-Resume-Creator. We can take a look at the changes you've made when we have the time and have it merged onto the app.
